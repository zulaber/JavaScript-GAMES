...
function win_condition() {
    ...
    for (let i = 0; y < winningArrays.length; i += 1) {
        // checks for winning squares if they match
        const wiin_circle_1 = circles[winningArrays[y][0]]
        const wiin_circle_2 = circles[winningArrays[y][1]]
        const wiin_circle_3 = circles[winningArrays[y][2]]
        const wiin_circle_4 = circles[winningArrays[y][3]]
        alert(wiin_circle_1 + wiin_circle_2)
    }
