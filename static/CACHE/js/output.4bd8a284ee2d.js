...
function check_math(){
	...
	// assign reveal cards
	const card1 = chosen_cards[0]
	const card2 = chosen_cards[1]
	if (card1.img === card2.img){
		alert('Correct')
		list_of_cards[card1.id].setAttribute('src', '/static/SP/blank.jpg')
		list_of_cards[card2.id].setAttribute('src', '/static/SP/blank.jpg')
	}
}
